        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1}} transition={{ duration: 0.4, delay: 5.3}} className="">
            ...
            {isActive ? (
                    <motion.div
                        ...
                        className="absolute top-0 left-0 w-[200px] z-10 h-screen bg-gray-800 flex flex-col justify-center items-center font-bold text-[20px] sm:text-[35px] gap-10 sm:w-[400px]"
                    >
