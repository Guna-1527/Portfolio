      ...
      <div className="About__Container__Content">
        ...
        <div className="About__Content">
          ...
          <div className="About__Content__Text">
            ...
            <p className="Text">Living in Tiruvannamalai. </p>
            <p className="Text"> Moved to Namakkal for complete my Senior Secondary in SKV Matric Higher secondary school.</p> 
            <p className="Text">And Currently pursuing my B.E. Computer Science and Engineering bacholar degree in Coimbatore.</p>
          </div>
        </div>
        </div>
      </div>
